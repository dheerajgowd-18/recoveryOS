...
class AblationResult(BaseModel):
    ...
    strategy_contribution_uplift_paise: int
    total_ai_uplift_paise: int
...
class AblationRunner:
    ...
    def run_ablation(
        ...
        strat_uplift = metrics_c.incremental_adjusted_net_recovery_paise - metrics_b.incremental_adjusted_net_recovery_paise
        ...
        ablation_summary = AblationResult(
            ...
            strategy_contribution_uplift_paise=strat_uplift,
            total_ai_uplift_paise=total_ai_uplift,
        )
    ...
    def _save_ablation_reports(self, summary: AblationResult) -> None:
        ...
        lines.extend([
            ...
            "",
            f"- **LLM Diagnosis Contribution**: ₹{summary.diagnosis_contribution_uplift_paise / 100.0:,.2f}",
            f"- **LLM Strategy Contribution**: ₹{summary.strategy_contribution_uplift_paise / 100.0:,.2f}",
            f"- **Total Combined AI Value**: ₹{summary.total_ai_uplift_paise / 100.0:,.2f}",
            "",
            "---",
